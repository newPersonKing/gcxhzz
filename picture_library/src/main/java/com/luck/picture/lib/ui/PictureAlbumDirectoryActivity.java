    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switch (type) {
            case LocalMediaLoader.TYPE_IMAGE:
                ...
                // {com.emcc.android.splendid/com.luck.picture.lib.ui.PictureAlbumDirectoryActivity}:
                // android.content.res.Resources$NotFoundException: String resource ID #0x7f0d0073
                // Caused by: android.content.res.Resources$NotFoundException: String resource ID #0x7f0d0073
