...
*/
    ...
    public <T> T rxGet(final String url, ResponseCallback<T, ResponseBody> callBack) {
        ...
        return rxGet(url, url, map, callBack);
    }
     ...
     * @return Rxjava 1.x Subscription
     */
    public <T> T rxUploadWithPartListByFileCustom(Object tag, String url, ContentType type, List<File> list, ResponseCallback<T, ResponseBody> callBack) {
