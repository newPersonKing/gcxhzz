...
public class AlTimePickerMinuteDialog implements DatePickerView.OnSelectMoveListener {
    ...
    public AlTimePickerMinuteDialog(Context context) {
        mContext = context;
    }

    public AlTimePickerMinuteDialog Builder() {
...
//        dialogWindow.setAttributes(lp);
    ...
    public AlTimePickerMinuteDialog setTitleShow(boolean isShow) {
        if (isShow) {
    ...
    private AlTimePickerMinuteDialog addSheetItem() {
        ...
        mDatePickerView.setSelected(30);// 29 当前时间的前一天 昨天 30指代当天
    ...
    public AlTimePickerMinuteDialog setPositiveClick(OnPositiveClick onPositiveClick) {
