...
public class DatePickerView extends View {
    ...
    private OnSelectMoveListener mSelectMoveListener;
    private Timer timer;
    ...
    public void setmSelectMoveListener(OnSelectMoveListener mSelectMoveListener) {
        this.mSelectMoveListener = mSelectMoveListener;
    }
...
//        mCurrentSelected = datas.size() / 4;
    ...
    private void init() {
        ...
        mMaxTextSize = R.dimen.sp_80;
        mMinTextSize = R.dimen.sp_40;
    ...
    private void drawData(Canvas canvas) {
        ...
        // TODO: 2018/5/17 高度与宽度因素决定字体的大小 进行比的控制选择
        float scale = parabola(mViewHeight / 4.0f, mMoveLen);
        float size = (mMaxTextSize - mMinTextSize) * scale / 1.5f + mMinTextSize;
...
//        // 绘制上方data 如果是第一次的话
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // MotionEvent.ACTION_CANCEL: 取消触发事件 系统 不会自动调用 由代码来执行
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                Log.d("DatePickerView", "event.getY():" + event.getY());

                break;

            case MotionEvent.ACTION_MOVE:
                if (null != mSelectMoveListener) {
                    mSelectMoveListener.onSelectMove();
                }
                Log.d("DataPickerView", "ACTION_MOVE");
...
//                postInvalidate();
    ...
    /**
     * 数据在第一次进入的时候 默认选择 今天 强制回调onSelect回调方法
     */
    void doUpInit() {
