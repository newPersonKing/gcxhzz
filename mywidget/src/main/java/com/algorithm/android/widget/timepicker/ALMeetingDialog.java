...
public class ALMeetingDialog implements DatePickerView.OnSelectMoveListener {
    ...
    private AlTimePickerDialog.OnPositiveClick mOnPositiveClick;

    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");

    public ALMeetingDialog(Context context) {
        mContext = context;
    }

    public ALMeetingDialog Builder() {
...
//        dialogWindow.setAttributes(lp);
    ...
    public ALMeetingDialog setTitleShow(boolean isShow) {
        if (isShow) {
    ...
    private ALMeetingDialog addSheetItem() {
    ...
    public ALMeetingDialog setPositiveClick(AlTimePickerDialog.OnPositiveClick onPositiveClick) {
