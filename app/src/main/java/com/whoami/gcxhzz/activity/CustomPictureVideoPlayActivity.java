...
public class CustomPictureVideoPlayActivity extends PictureBaseActivity implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.luck.picture.lib.R.layout.picture_activity_video_play);
        video_path = getIntent().getStringExtra("video_path");
        picture_left_back = (ImageView) findViewById(com.luck.picture.lib.R.id.picture_left_back);
        mVideoView = (VideoView) findViewById(com.luck.picture.lib.R.id.video_view);
    ...
    public void onStart() {
        ...
        Log.i("ccccccccc","locationFile==="+locationPath);
        if(locationFile.exists()){
            mVideoView.setVideoPath(locationPath);
        }else{
