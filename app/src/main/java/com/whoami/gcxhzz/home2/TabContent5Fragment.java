...
public class TabContent5Fragment extends BaseFragment {
    ...
    public static TabContent5Fragment newInstance(){
        return new TabContent5Fragment();
    }
    ...
    protected void onInitData() {
        ...
        RxBus.getDefault().toObservable(String.class).subscribe(new Action1<String>() {
            ...
            public void call(String str) {
                switch (str){
                    case "1":
                        tv_content.setText(getString(R.string.A5));
                        break;
                    case "2":
                        tv_content.setText(getString(R.string.B5));
                        break;
                    case "3":
                        tv_content.setText(getString(R.string.C5));
                        break;
                    case "4":
                        tv_content.setText(getString(R.string.D5));
                        break;
                    case "5":
                        tv_content.setText(getString(R.string.E5));
                        break;
                    case "6":
                        tv_content.setText(getString(R.string.F5));
                        break;
                    case "7":
                        tv_content.setText(getString(R.string.G5));
                        break;
                }
            }
        });
